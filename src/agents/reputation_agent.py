...
def generate_reputation_queries_node(state: ReputationAgentState) -> ReputationAgentState:
    print("[ReputationAgent] Generating queries for reputation...")
    state['generated_queries'] = ["placeholder query 1 for reputation", "placeholder query 2 for reputation"]
    return state
